    ...
    backgroundRepeat: 'no-repeat'
      ...
      <nav className="absolute top-6 left-0 right-0 z-10 flex justify-between items-center px-6" data-magicpath-id="1" data-magicpath-path="HeroSection.tsx">
        ...
        <div className="flex gap-3" data-magicpath-id="4" data-magicpath-path="HeroSection.tsx">
          ...
          <button className="inline-block px-6 py-2 bg-black text-white text-sm font-medium rounded-full hover:bg-[#8b7fff] focus:ring-4 focus:ring-[#8b7fff]/30 transition-all duration-300 text-center" data-magicpath-id="6" data-magicpath-path="HeroSection.tsx">
            Sign up
          </button>
        </div>
      </nav>
      ...
      {/* Main content */}
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6 border-0 outline-none" data-magicpath-id="7" data-magicpath-path="HeroSection.tsx">
        <div className="text-center max-w-4xl mx-auto" data-magicpath-id="8" data-magicpath-path="HeroSection.tsx">
          ...
          ease: "easeOut"
            ...
            <div className="flex flex-col items-center -space-y-4" data-magicpath-id="10" data-magicpath-path="HeroSection.tsx">
              <span className="block" data-magicpath-id="11" data-magicpath-path="HeroSection.tsx">Make every</span>
              <span className="block" data-magicpath-id="12" data-magicpath-path="HeroSection.tsx">post</span>
              <TypingEffect words={["Effortless", "viral", "Wins"]} colors={["#989cfc", "#fc7557", "#f9c558"]} className="block mt-2" data-magicpath-id="13" data-magicpath-path="HeroSection.tsx" />
            </div>
          </motion.h1>
          ...
          display: "none"
            ...
            <p className="text-lg text-gray-700 mb-8 font-light" data-magicpath-id="19" data-magicpath-path="HeroSection.tsx">
            ...
            <p className="text-gray-500 text-sm font-light" data-magicpath-id="21" data-magicpath-path="HeroSection.tsx">
