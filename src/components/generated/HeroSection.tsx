...
const HeroSection: React.FC = () => {
  return <section className="relative min-h-screen overflow-hidden" style={{
    ...
    backgroundRepeat: 'no-repeat'
      ...
      <nav className="absolute top-6 left-0 right-0 z-10 flex justify-between items-center px-6">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2">
          ...
          fontFamily: 'system-ui, -apple-system, sans-serif'
            ...
            <em>R</em><span>eaxo</span>
          </h1>
        </div>
        
        {/* Login/Signup buttons */}
        <div className="flex gap-3 ml-auto">
          <button className="inline-block px-6 py-2 bg-white text-gray-900 text-sm font-medium rounded-full hover:bg-[#fe8363] hover:text-white focus:ring-4 focus:ring-[#fe8363]/30 transition-all duration-300 text-center border border-gray-200">
            Login
          </button>
          <button className="inline-block px-6 py-2 bg-black text-white text-sm font-medium rounded-full hover:bg-[#8b7fff] focus:ring-4 focus:ring-[#8b7fff]/30 transition-all duration-300 text-center">
            Sign up
          </button>
        </div>
      </nav>
      ...
      {/* Main content */}
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6 border-0 outline-none">
        <div className="text-center max-w-4xl mx-auto">
          ...
          ease: "easeOut"
            ...
            <div className="flex flex-col items-center -space-y-4">
              ...
              <TypingEffect words={["Effortless", "viral", "Wins"]} colors={["#989cfc", "#fc7557", "#f9c558"]} className="block mt-2" />
            </div>
          </motion.h1>
          ...
          delay: 0.2,
          ease: "easeOut"
        }}>Stop struggling to understand your social performance. Our tools break down the numbers so you can focus on creating, connecting, and growing across every channel with confidence.</motion.p>
